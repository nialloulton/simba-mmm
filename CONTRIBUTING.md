# Contributing to Simba Documentation

Thank you for your interest in improving the Simba documentation. This guide explains how to report issues, suggest features, and contribute to making Simba better for everyone.
...
If you have questions about using Simba:
...
If you'd like to improve the documentation itself:

1. Fork this repository
2. Create a branch for your changes
3. Make your edits following the existing style and structure
4. Submit a pull request with a clear description of what you changed and why

### Documentation Style Guide

- Use clear, concise language accessible to marketing professionals
- Explain technical concepts (Bayesian modeling, priors, etc.) in plain terms before diving into detail
